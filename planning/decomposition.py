...
class TaskNode(BaseModel):
    ...
    # --- added by teammate 2 (planning/orchestrator.py) so router.dispatch() has
    # enough context to run each sub-task against the real customer/accounts
    # under investigation. Optional + default-populated, so nothing above
    # this line (teammate 1's decomposition/cycle-check logic, and her
